 ...
 * Quando a flag está desligada, esta função retorna antes de instanciar ou
 * consultar o repositório candidato.
 *
 * Quando habilitada futuramente, a comparação só roda se a leitura primária
 * representar o conjunto completo dos filtros suportados. Busca textual ampla
 * e resultados truncados são deliberadamente ignorados para evitar falsos
 * diagnósticos de paridade.
 */
...
} from "backend/agendamentosRepository";
import {
  createWixAppointmentsRepository,
} from "backend/agendamentosRepositoryWix";
import {
  createWixAppointmentsShadowReader,
} from "backend/agendamentosShadowReadWix";
